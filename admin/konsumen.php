<?php
//Konfigurasi Halaman
$_halaman_judul_tab = 'Konsumen';
$_halaman_judul_halaman = 'Konsumen';
$_halaman_judul_card = 'Konsumen';
$_halaman_footer_card = 'Konsumen';

//Variabel MySQL
include('_koneksi.php');

$sql_tabel = "SELECT * FROM konsumen";
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-form" onclick="aksi('konsumen_form.php','tambah',null);">Tambah Konsumen Baru</button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
              ...
              <?php
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_tabel['alamat']; ?></td>
                    <td><?php echo $data_tabel['telepon']; ?></td>
                    <td>
                      <button onclick="aksi('konsumen_form.php','edit','<?php echo $data_tabel['id_konsumen']; ?>');" class="btn btn-success aksi" data-toggle="modal" data-target="#modal-form">Edit</button>
                      <a href="konsumen_proses.php?mode=hapus&id=<?php echo $data_tabel['id_konsumen']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                }
