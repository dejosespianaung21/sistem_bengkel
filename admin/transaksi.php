<?php
//Konfigurasi Halaman
$_halaman_judul_tab = 'transaksi';
$_halaman_judul_halaman = 'transaksi';
$_halaman_judul_card = 'transaksi';
$_halaman_footer_card = 'transaksi';

//Variabel MySQL
include('_koneksi.php');

$sql_tabel = "SELECT * FROM transaksi";
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-form" onclick="aksi('transaksi_form.php','tambah',null);">Tambah Transaksi</button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_tabel['konsumen']; ?></td>
                    ...
                    <td>
                      <button onclick="aksi('transaksi_form.php','edit','<?php echo $data_tabel['id']; ?>');" class="btn btn-success aksi" data-toggle="modal" data-target="#modal-form">Edit</button>
                      <a href="transaksi_proses.php?mode=hapus&id=<?php echo $data_tabel['id']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                }
