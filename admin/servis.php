<?php
//Konfigurasi Halaman
$_halaman_judul_tab = 'Servis';
$_halaman_judul_halaman = 'Servis';
$_halaman_judul_card = 'Servis';
$_halaman_footer_card = 'Servis';

//Variabel MySQL
include('_koneksi.php');

$sql_tabel = "SELECT * FROM servis";
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-form" onclick="aksi('servis_form.php','tambah',null);">Tambah Servis Baru</button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
              ...
              <?php
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_tabel['tanggal_servis']; ?></td>
                    <td><?php echo $data_tabel['deskripsi']; ?></td>
                    <td><?php echo $data_tabel['biaya_servis']; ?></td>
                    <td>
                      <button onclick="aksi('servis_form.php','edit','<?php echo $data_tabel['id_servis']; ?>');" class="btn btn-success aksi" data-toggle="modal" data-target="#modal-form">Edit</button>
                      <a href="servis_proses.php?mode=hapus&id=<?php echo $data_tabel['id_servis']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                }
