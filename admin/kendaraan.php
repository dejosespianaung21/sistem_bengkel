<?php
//Konfigurasi Halaman
$_halaman_judul_tab = 'Motor';
$_halaman_judul_halaman = 'Motor';
$_halaman_judul_card = 'Motor';
$_halaman_footer_card = 'Motor';

//Variabel MySQL
include('_koneksi.php');

$sql_tabel = "SELECT * FROM kendaraan";
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-form" onclick="aksi('kendaraan_form.php','tambah',null);">Tambah Motor Baru</button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
              ...
              <?php
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_tabel['merek']; ?></td>
                    <td>
                      <button onclick="aksi('kendaraan_form.php','edit','<?php echo $data_tabel['id_kendaraan']; ?>');" class="btn btn-success aksi" data-toggle="modal" data-target="#modal-form">Edit</button>
                      <a href="kendaraan_proses.php?mode=hapus&id=<?php echo $data_tabel['id_kendaraan']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                }
